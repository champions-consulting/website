        ...
        <div className="container mx-auto px-4 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="list-disc list-inside text-gray-700">
                  <li className="mb-2">
                    <strong>React & Next.js:</strong> Building dynamic
                    single-page applications and server-rendered web
                    applications for optimal performance and SEO.
                  </li>
                  <li className="mb-2">
          ...
          <section className="mb-12">
            ...
            <ol className="list-decimal list-inside text-gray-700">
              <li className="mb-4">
                ...
                you to understand your business needs and project goals. (Based
                on &quot;Stakeholder Collaboration&quot; and &quot;Business
              ...
              <li className="mb-4">
                ...
                high-quality code adhering to best practices. (Based on
                &quot;Full Stack Development&quot; responsibilities)
              </li>
              <li className="mb-4">
                <strong>Testing & Quality Assurance:</strong> We ensure robust
                functionality and performance through rigorous testing. (Based
                on &quot;Code Quality&quot; and &ldquo;Perfromance
                Optimisation&quot;)
              </li>
              <li className="mb-4">
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-gray-700">
              ...
              <li className="mb-2">
                <strong>Scalability & Performance:</strong> We build
                applications designed to grow and perform under high load.
              </li>
              <li className="mb-2">
                <strong>Modern Technologies:</strong> We utilize the latest
              ...
              <li className="mb-2">
                <strong>Collaborative Approach:</strong> We work closely with
                you throughout the development lifecycle.
              </li>
            </ul>
          </section>
        </div>
